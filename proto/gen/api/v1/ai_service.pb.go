...
func (x *SearchMemosRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
type SearchMemosResponse struct {
	...
	Results       []*SearchMemosResponse_Result `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SearchMemosResponse) GetResults() []*SearchMemosResponse_Result {
	if x != nil {
		return x.Results
	}
	return nil
...
type SearchMemosResponse_Result struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The matched memo.
...
func (x *SearchMemosResponse_Result) Reset() {
	*x = SearchMemosResponse_Result{}
	mi := &file_api_v1_ai_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SearchMemosResponse_Result) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchMemosResponse_Result) ProtoMessage() {}

func (x *SearchMemosResponse_Result) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_ai_service_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchMemosResponse_Result.ProtoReflect.Descriptor instead.
func (*SearchMemosResponse_Result) Descriptor() ([]byte, []int) {
	return file_api_v1_ai_service_proto_rawDescGZIP(), []int{4, 0}
}

func (x *SearchMemosResponse_Result) GetMemo() *Memo {
	if x != nil {
		return x.Memo
	}
	return nil
...
func (x *SearchMemosResponse_Result) GetScore() float32 {
	if x != nil {
		return x.Score
	}
	return 0
...
const file_api_v1_ai_service_proto_rawDesc = "" +
	"\n" +
	"\x17api/v1/ai_service.proto\x12\fmemos.api.v1\x1a\x19api/v1/memo_service.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\"P\n" +
	...
	"\x05limit\x18\x02 \x01(\x05B\x03\xe0A\x01R\x05limit\"\xa1\x01\n" +
	"\x13SearchMemosResponse\x12B\n" +
	"\aresults\x18\x01 \x03(\v2(.memos.api.v1.SearchMemosResponse.ResultR\aresults\x1aF\n" +
	"\x06Result\x12&\n" +
	"\x04memo\x18\x01 \x01(\v2\x12.memos.api.v1.MemoR\x04memo\x12\x14\n" +
	"\x05score\x18\x02 \x01(\x02R\x05score2\x85\x02\n" +
	"\tAIService\x12y\n" +
	"\n" +
	"Transcribe\x12\x1f.memos.api.v1.TranscribeRequest\x1a .memos.api.v1.TranscribeResponse\"(\xdaA\x05audio\x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/api/v1/ai:transcribe\x12}\n" +
	"\vSearchMemos\x12 .memos.api.v1.SearchMemosRequest\x1a!.memos.api.v1.SearchMemosResponse\")\xdaA\x05query\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/api/v1/ai:searchMemosB\xa6\x01\n" +
...
var file_api_v1_ai_service_proto_goTypes = []any{
	...
	(*SearchMemosRequest)(nil),         // 3: memos.api.v1.SearchMemosRequest
	(*SearchMemosResponse)(nil),        // 4: memos.api.v1.SearchMemosResponse
	(*SearchMemosResponse_Result)(nil), // 5: memos.api.v1.SearchMemosResponse.Result
...
var file_api_v1_ai_service_proto_depIdxs = []int32{
	...
	5, // 1: memos.api.v1.SearchMemosResponse.results:type_name -> memos.api.v1.SearchMemosResponse.Result
	6, // 2: memos.api.v1.SearchMemosResponse.Result.memo:type_name -> memos.api.v1.Memo
	0, // 3: memos.api.v1.AIService.Transcribe:input_type -> memos.api.v1.TranscribeRequest
	3, // 4: memos.api.v1.AIService.SearchMemos:input_type -> memos.api.v1.SearchMemosRequest
	2, // 5: memos.api.v1.AIService.Transcribe:output_type -> memos.api.v1.TranscribeResponse
	4, // 6: memos.api.v1.AIService.SearchMemos:output_type -> memos.api.v1.SearchMemosResponse
