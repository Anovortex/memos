...
const (
	...
	// Fork scopes: email verification, emailed-token redemption, and semantic search.
	// ScopeEmailVerifyUser counts verification email sends per user.
	ScopeEmailVerifyUser Scope = "email_verify_user"
	// ScopeTokenIP counts emailed-token redemptions (verify email, reset password) per client address.
